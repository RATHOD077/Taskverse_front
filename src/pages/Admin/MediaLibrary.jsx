                ...
                {pagedFolders.map((folder) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded-lg hover:bg-rose-50 text-slate-300 hover:text-rose-500"
                    >
                      <Trash2 size={13} />
                    </button>
